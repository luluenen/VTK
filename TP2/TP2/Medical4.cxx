...
int main (int argc, char *argv[])
{
  ...
  */ 
  ...
  // and another color for bone (1150 and over).
    // a vous de trouver les bonnes couleurs
  vtkSmartPointer<vtkColorTransferFunction>volumeColor =
    vtkSmartPointer<vtkColorTransferFunction>::New();
  volumeColor->AddRGBPoint(0,    0.0, 0.0, 0.0);
  volumeColor->AddRGBPoint(500,  0.3, 0.3, 0.3);
  volumeColor->AddRGBPoint(1000, 0.3, 0.3, 0.3);
  volumeColor->AddRGBPoint(1150, 0.3, 0.3, 0.3);

  // The opacity transfer function is used to control the opacity
  // of different tissue types.
    // et les bonnes opacités
  vtkSmartPointer<vtkPiecewiseFunction> volumeScalarOpacity =
    vtkSmartPointer<vtkPiecewiseFunction>::New();
  volumeScalarOpacity->AddPoint(0,    0.00);
  volumeScalarOpacity->AddPoint(500,  0.2);
  volumeScalarOpacity->AddPoint(1000, 0.2);
  volumeScalarOpacity->AddPoint(1150, 0.2);
